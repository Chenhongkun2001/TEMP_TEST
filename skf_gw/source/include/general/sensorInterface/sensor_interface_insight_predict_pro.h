/**
 * @file    sensor_interface_insight_predict_pro.h
 * @author  Xiaoyuan (Sean) Ma
 * @date    2025-03-24
 * @brief   Definition of sensor interface for InsightPredictPro
 * @details
 */
#ifndef __SENSOR_INTERFACE_INSIGHT_PREDICT_PRO_H__
#define __SENSOR_INTERFACE_INSIGHT_PREDICT_PRO_H__
...
bool registerSensorIntfInsightPredictPro(
  struct sensor_interface *sensorIntf,
  uint8_t *errCode);
bool unregisterSensorIntfInsightPredictPro(
  struct sensor_interface *sensorIntf,
  uint8_t *errCode);

#endif /* __SENSOR_INTERFACE_INSIGHT_PREDICT_PRO_H__ */
